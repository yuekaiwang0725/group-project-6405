...
# SST-2 validation split -- official 872-sample evaluation set
raw         = load_dataset("glue", "sst2")
val_data    = raw["validation"]
test_texts  = val_data["sentence"]
test_labels = val_data["label"]

loader = DataLoader(SST2Dataset(test_texts, test_labels, tokenizer, MAX_LEN), BATCH_SIZE)
...
# Patch into existing results JSON
