...
test_texts  = list(val_data["text"])
test_labels = list(val_data["label"])

loader = DataLoader(EmotionDataset(test_texts, test_labels, tokenizer, MAX_LEN), BATCH_SIZE)
...
print(f"True dist: {dict(sorted(Counter(truths.tolist()).items()))}")
